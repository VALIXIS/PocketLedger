...
void main() {
  ...
  group('AnalyticsHelper - Day 1 Telemetry Engine', () {
    group('1. Category Percentage (Category %)', () {
      test('calculates correct percentages for multiple expense categories', () {
        final transactions = [
          Transaction(
            id: '1',
    ...
    group('2. Cashflow Velocity', () {
      test('calculates average net cashflow per day correctly over a multi-day period', () {
        final day1 = DateTime(2026, 9, 1);
        final day10 = DateTime(2026, 9, 10); // 10 days total (Sept 1 to Sept 10 inclusive)
      ...
      test('returns 0.0 velocity for empty transactions or invalid date range', () {
    ...
    group('3. Income / Expense Ratio', () {
      ...
      test('returns 0.0 safe value when expenses are zero (prevents division by zero)', () {
        final transactions = [
          Transaction(
            id: '1',
            type: TransactionType.income,
    ...
    group('5. Supporting Calculations & Edge Cases', () {
      ...
      test('generateReport produces comprehensive and accurate AnalyticsReport', () {
