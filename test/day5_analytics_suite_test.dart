...
void main() {
  ...
  group('Day 5 Full Analytics Suite Tests', () {
    ...
    group('1. Net Worth Summary & Telemetry Calculations', () {
      test('1-6. Net worth, total income, total expenses, savings rate, and zero-income savings rate', () {
        final transactions = [
          Transaction(
            id: '1',
    ...
    group('2. Top Merchants (Grouping, Sorting, Counts & Empty Handling)', () {
      test('7-10. Top merchant grouping, sorting by spending, tx counts, and empty handling', () {
        // Empty merchant test
        ...
        final top = AnalyticsHelper.calculateTopMerchants(transactions, limit: 5);
    ...
    group('3. Category Velocity (Calculation, Sorting & Calendar Days)', () {
      test('11-13. Category velocity calculation, sorting by velocity, and calendar days', () {
        // Sept 1 to Sept 10 = 10 calendar days
        final transactions = [
          Transaction(
            id: '1',
            type: TransactionType.expense,
            amountInCents: 500000, // $5,000 Food -> Velocity = 5000/10 = 500/day
            category: 'food',
            date: d1,
            note: '',
            createdAt: d1,
          ...
          Transaction(
            id: '2',
            type: TransactionType.expense,
            amountInCents: 200000, // $2,000 Transport -> Velocity = 2000/10 = 200/day
            category: 'transport',
            date: d10,
            note: '',
            createdAt: d10,
        ...
        final velocities = AnalyticsHelper.calculateCategoryVelocities(transactions);
    ...
    group('4. AnalyticsScreen UI & Providers Integration', () {
      testWidgets('14. Renders full AnalyticsScreen with 4 sections and empty state handling', (tester) async {
