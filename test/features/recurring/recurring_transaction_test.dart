...
void main() {
  group('RecurringTransaction Model & Domain Logic Tests', () {
    ...
    test('4. Monthly recurrence handles standard dates across months', () {
      ...
      final nextYearBoundary = rt.copyWith(
        nextOccurrence: DateTime(2026, 12, 15),
      );
      expect(nextYearBoundary.calculateNextOccurrence(), DateTime(2027, 1, 15));
    });

    test(
      '5. Monthly recurrence handles month-end dates and leap years correctly',
      () {
        ...
        final rtJan31Leap = rtJan31.copyWith(
        ...
        final rtOct31 = rtJan31.copyWith(
          nextOccurrence: DateTime(2026, 10, 31),
        );
    ...
    test(
      '6. Yearly recurrence works and handles leap year rollover safely',
      () {
        ...
        final rtLeapYear = rtAnnual.copyWith(
    ...
    test(
      '7. End dates are respected and transaction is automatically cancelled past end date',
      () {
    ...
    test(
      '9. Reminder calculation calculates correct window for notification',
      () {
    ...
    test(
      '10. Inactive or reminder-disabled transactions do not show reminders',
      () {
    ...
    test(
      '11. copyWith preserves unchanged values and supports clearing endDate',
      () {
        final rt = RecurringTransaction(
          id: 'rec-11',
          name: 'Streaming',
