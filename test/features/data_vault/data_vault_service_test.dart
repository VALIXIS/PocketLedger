...
void main() {
  ...
  group('DataVaultService — Backup, Restore & Safety Tests', () {
    ...
    test('1. createBackupPayload includes all transactions and categories', () async {
    ...
    test('2. exportEncryptedBackup and validateEncryptedBackup roundtrip', () async {
    ...
    test('4. restoreFromEncrypted in overwrite mode restores records cleanly', () async {
    ...
    test('5. restoreFromEncrypted in merge mode merges without overwriting non-colliding items', () async {
    ...
    test('6. Restore safety: rollback snapshot when write failure occurs during restore (no partial writes)', () async {
      final newBackupPayload = BackupPayload(
        transactions: [
          Transaction(
            id: 'tx-incoming-1',
    ...
    test('7. Corrupted encrypted backup does not alter existing data', () async {
